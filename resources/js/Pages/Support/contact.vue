          ...
          <div class="row">
            <div class="col-sm-12 col-md-4">
              <div class="service-section">
                <img class="svg animal" src="patterns/lion.svg" alt="" />
                <div class="title">London</div>
                <div class="subtitle">Call us: + (123) 1300-656-1046 <br />HeadQuarters - No.01 - 399-0 Lorem Street City Melbourne</div>
                <a class="btn btn-default-yellow-fill popup-gmaps" href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Google Maps</a>
              </div>
            </div>
            <div class="col-sm-12 col-md-4">
              <div class="service-section">
                <div class="plans badge feat bg-pink">office</div>
                <img class="svg animal" src="patterns/cock.svg" alt="" />
                <div class="title">Lisbon</div>
                <div class="subtitle">Call us: + (123) 1300-656-1046 <br />Office - No.01 - 399-0 Lorem Street City Portugal</div>
                <a class="btn btn-default-yellow-fill popup-gmaps" href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Google Maps</a>
              </div>
            </div>
            <div class="col-sm-12 col-md-4">
              <div class="service-section">
                <img class="svg animal" src="patterns/kangaroo.svg" alt="" />
                <div class="title">Melbourne</div>
                <div class="subtitle">Call us: + (123) 1300-656-1046 <br />Office - No.02 - 399-0 Lorem Street City London</div>
                <a class="btn btn-default-yellow-fill popup-gmaps" href="https://maps.google.com/maps?q=221B+Baker+Street,+London,+United+Kingdom&amp;hl=en&amp;t=v&amp;hnear=221B+Baker+St,+London+NW1+6XE,+United+Kingdom">Google Maps</a>
              </div>
            </div>
          </div>
                ...
                <form id="contactForm" method="POST">
                  <div class="row">
                    ...
                    <div class="col-md-6 mt-5">
                      ...
                      <label for="checkbox" class="checkbox-label c-grey mb-4"
                        ><div>I have read and accept the terms of the privacy policy - <a href="legal" class="golink">RGPD</a></div></label
                      >
