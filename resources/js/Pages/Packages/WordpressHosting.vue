<template>
  <div>
    ...
    <!-- ***** WHY CHOOSE ANTLER ***** -->
    <section class="services sec-normal sec-bg3 cpupath-w">
      <div class="container">
        <div class="service-wrap">
          <div class="row">
            <div class="col-sm-12">
    ...
    <section class="sec-normal">
      <div class="best-plans pricing">
        <div class="container">
          ...
          <div class="sec-main sec-bg1">
            <div class="plans badge feat bg-pink">Compare All WordPress Plans</div>
            <div class="row">
              <div class="col-sm-12">
                <div id="table-container" class="table-responsive-lg">
                  <table id="maintable" class="table">
                    <thead>
                      <tr>
                        ...
                        <td>
                          ...
                          <div class="price"><sup>$</sup>6.19<span class="period">/mo</span></div>
                          <div class="plans badge bg-grey">Renews $8.66 /mo</div>
                          <div class="info">Sed ut perspiciatis unde omnis iste natus error sit voluptatem</div>
                        ...
                        <td>
                          ...
                          <div class="price"><sup>$</sup>19.00<span class="period">/mo</span></div>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="title-table" data-toggle="tooltip" data-placement="top" title="" data-original-title="I must explain to you">Websites</div>
                        </td>
                        <td>2 Websites</td>
                        <td>4 Websites</td>
                        <td>8 Websites</td>
                      ...
                      <tr>
                        <td>
                          <div id="element" class="title-table" data-toggle="tooltip" data-placement="top" title="" data-original-title="I must explain to you">SSD Storage</div>
                        </td>
                        <td>40GB SSD</td>
                        <td>60GB SSD</td>
                        <td>120GB SSD</td>
