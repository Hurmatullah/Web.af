  ...
  <div>
    ...
    <div class="covervid-wrapper">
      <video class="covervid-video" autoplay loop muted poster="img/topbanner03.jpg">
        <source src="videos/Modem-lights.webm" type="video/webm" />
          ...
          <div class="row">
            <div class="col-md-10 offset-md-1">
              <div class="info-content">
                <h4>Fully scalable to grow with you</h4>
          ...
          <div class="row">
            <div class="col-md-10 offset-md-1">
              <div class="info-content">
                ...
                <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will. Lorem ipsum dolor sit amet, <a href="#" class="golink">consectetur adipiscing elit,</a> sed do eiusmod tempor incididunt.</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
              </div>
            </div>
            <div class="col-md-10 offset-md-1 pt-5 wow animated fadeInUp fast">
              <img class="svg" src="patterns/provisioning.svg" alt="provisioning" />
            </div>
          </div>
          <div class="row">
            <div class="col-md-10 offset-md-1">
              <div class="info-content">
                <h4>Redundant infrastructure</h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, <a href="#" class="golink">quis nostrud exercitation ullamco</a> laboris nisi.</p>
                <p>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will. Lorem ipsum dolor sit amet.</p>
              </div>
            </div>
            <div class="col-md-10 offset-md-1 pt-5 wow animated fadeInUp fast">
              <img class="svg" src="patterns/redundant.svg" alt="redundant" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="btn-floats">
              <a class="btn btn-default-yellow-fill mr-3 popup-youtube" href="http://www.youtube.com/watch?v=0O2aH4XLbto">Video Data Center</a>
    ...
    <section class="sec-normal sec-bg1">
      <div class="best-plans pricing">
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-12">
              <h2 class="section-heading">VPS Server Technical Specifications</h2>
            ...
            <div class="col-sm-12">
              <div class="table-responsive-lg">
                <table class="table sample mt-5">
                  <thead>
                    <tr>
                      <td><span class="title">Features </span></td>
                      <td><div class="title">Performance</div></td>
                      <td><div class="title">Boosters</div></td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td>
                        <div class="title-table" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle mr-2"></span> CentOS 6/7, Ubuntu 16v</div>
                      </td>
                      <td><span class="fas fa-check-circle mr-2"></span> SSD Storage</td>
                      <td><span class="fas fa-check-circle mr-2"></span> cPanel</td>
                    </tr>

                    <tr>
                      <td>
                        <div class="title-table" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus."><span class="fas fa-check-circle mr-2"></span> Fedora 23, Debian 8</div>
                      </td>
                      <td><span class="fas fa-check-circle mr-2"></span> Tier IV Data Center</td>
                      <td><span class="fas fa-check-circle mr-2"></span> Plesk Onyx</td>
                    </tr>
                    <tr>
                      <td class="title-table"><span class="fas fa-check-circle mr-2"></span> Private Network</td>
                      <td><span class="fas fa-check-circle mr-2"></span> Juniper Networks</td>
                      <td><span class="fas fa-check-circle mr-2"></span> WHMCS</td>
                    </tr>
                    <tr>
                      <td class="title-table"><span class="fas fa-check-circle mr-3"></span> Quick VNC access</td>
                      <td><span class="fas fa-check-circle mr-2"></span> DDos mitigation</td>
                      <td><span class="fas fa-check-circle mr-2"></span> SAN storage</td>
                    </tr>
    ...
    <!-- ***** CUSTOM VPS SLIDER ***** -->
    <section id="custom" class="sec-normal sec-bg3 motpath-w">
      <div class="container">
            ...
            <div class="col-md-12 col-lg-9">
              <div class="row">
                <div class="col-sm-12 col-md-4">
                  <h3 class="title"><i class="icon-cpu"></i> CPU <span id="cpu-val" class="info">---</span></h3>
                </div>
                <div class="col-sm-12 col-md-4">
                  <h3 class="title"><i class="icon-ram"></i> RAM <span id="ram-val" class="info">---</span></h3>
                </div>
                <div class="col-sm-12 col-md-4">
                  <h3 class="title"><i class="icon-drivessd"></i> Disk Space <span id="disk-val" class="info">---</span></h3>
                </div>
                <div class="col-sm-12 col-md-4">
                  <h3 class="title"><i class="icon-speed"></i> Bandwidth <span id="bw-val" class="info">---</span></h3>
                </div>
                <div class="col-sm-12 col-md-4">
                  <h3 class="title"><i class="icon-repair"></i> Setup <span id="setup-val" class="info">---</span></h3>
                </div>
                <div class="col-sm-12 col-md-4">
                  <h3 class="title"><i class="icon-network"></i> IP Address<span id="ip-val" class="info">---</span></h3>
                </div>
              </div>
            </div>
              ...
              <div class="h-plans-info">
                <div class="content-price price-container">
                  ...
                  <div class="price-content">
                    ...
                    <div class="infos">
                      <div class="badge feat bg-grey">Info</div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <h2 class="section-heading">Frequently Asked Questions VPS</h2>
              <p class="section-subheading">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt.</p>
            </div>
            <div class="col-sm-12">
