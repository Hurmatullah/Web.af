          ...
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper first text-left wow animated fadeInUp fast">
              <div class="top-content">
                <img class="svg mb-3" src="fonts/svg/privacy.svg" alt="" />
                <div class="title">Positive SSL</div>
                <div class="fromer">+ VAT at 20%</div>
                <div class="price"><sup>$</sup>39.99 <span class="period">/year</span></div>
                <a href="" class="btn btn-default-yellow-fill">Buy now</a>
              </div>
              <ul class="list-info">
                <li>
                  <i class="icon-lock"></i> <span class="c-purple">DOMAIN</span><br />
                  <span>Secure HTTPS</span>
                </li>
                <li>
                  <i class="icon-browser"></i> <span class="c-purple">BROWSER</span><br />
                  <span>Padlock visible</span>
                </li>
                <li>
                  <i class="icon-money"></i> <span class="c-purple">WARRANTY</span><br />
                  <span>No included</span>
                </li>
                <li>
                  <i class="icon-key"></i> <span class="c-purple">ENCRYPTION</span><br />
                  <span>128/256 bit SHA-2</span>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper text-left wow animated fadeInUp">
              ...
              <div class="top-content">
                ...
                <div class="fromer">+ VAT at 20%</div>
                <div class="price"><sup>$</sup>88.00 <span class="period">/year</span></div>
                <a href="" class="btn btn-default-yellow-fill">Buy now</a>
              </div>
              <ul class="list-info bg-purple">
                <li>
                  <i class="icon-lock"></i> <span class="c-pink">DOMAIN</span><br />
                  <span>Secure HTTPS</span>
                </li>
                <li>
                  <i class="icon-browser"></i> <span class="c-pink">BROWSER</span><br />
                  <span>Padlock visible</span>
                </li>
                <li>
                  <i class="icon-money"></i> <span class="c-pink">WARRANTY</span><br />
                  <span>$250.000</span>
                </li>
                <li>
                  <i class="icon-key"></i> <span class="c-pink">ENCRYPTION</span><br />
                  <span>128/256 bit SHA-2</span>
                </li>
              </ul>
            </div>
          ...
          <div class="col-sm-12 col-md-4 col-lg-4">
            <div class="wrapper third text-left wow animated fadeInUp fast">
              <div class="top-content">
                ...
                <div class="fromer">+ VAT at 20%</div>
                <div class="price"><sup>$</sup>110.99 <span class="period">/year</span></div>
                <a href="" class="btn btn-default-yellow-fill">Buy now</a>
              </div>
              <ul class="list-info">
                <li>
        ...
        <div class="sec-main sec-bg1">
          <div class="row">
            <div class="col-md-12 col-lg-6 wow animated fadeInUp fast first">
              <img class="svg" src="patterns/protectvisitors.svg" alt="git" />
            </div>
            <div class="col-md-12 col-lg-5 offset-lg-1">
              <div class="info-content">
                <h4>Protect your visitors</h4>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-lg-6 offset-lg-1 wow animated fadeInUp fast second">
              <img class="svg" src="patterns/ssl.svg" alt="deployment" />
            </div>
          </div>
          <hr />
          <div class="row">
            <div class="col-md-12 col-lg-6 wow animated fadeInUp fast third">
              <img class="svg" src="patterns/ranking.svg" alt="ranking" />
            </div>
            <div class="col-md-12 col-lg-5 offset-lg-1">
              <div class="info-content">
                <h4>Increase your rankings and grow</h4>
                <p>But I must explain to you how all this mistaken idea of <a href="#" class="golink">denouncing pleasure</a> and praising pain was born and I will.</p>
              </div>
              <a href="" class="btn btn-default-yellow-fill mt-3">About ranking</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="sec-normal">
      <div class="best-plans pricing">
        <div class="container">
          ...
          <div class="sec-main sec-bg1">
            <div class="plans badge feat bg-pink">Compare All SSL Plans</div>
            <div class="row">
              <div class="col-sm-12">
                <div id="table-container" class="table-responsive-lg">
                  <table id="maintable" class="table">
                    <thead>
                      <tr>
                        ...
                        <td>
                          <div class="title">Positive SSL</div>
                          <div class="price"><sup>$</sup>39.99<span class="period">/year</span></div>
                          <div class="info">Sed ut perspiciatis unde omnis natus error voluptatem</div>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="title-table" data-toggle="tooltip" data-placement="top" title="" data-original-title="I must explain to you">Domain Validation</div>
                        </td>
                      ...
                      <tr>
                        <td>
                          <div id="element" class="title-table" data-toggle="tooltip" data-placement="top" title="" data-original-title="I must explain to you">Trust Logo Supported</div>
                        </td>
                      ...
                      <tr>
                        <td class="title-table">Sub-domains</td>
                        <td>5 Sub-domain</td>
                        <td>15 Sub-domain</td>
                        <td>Unlimited</td>
                      </tr>
                      <tr>
                        <td class="title-table">Issued</td>
                        <td>2 Days</td>
                        <td>4 Days</td>
                        <td>6 Days</td>
                      </tr>
                      <tr>
                        <td class="title-table">Reissuance</td>
                        <td>Free</td>
                        <td>Free</td>
                        <td>Free</td>
                      </tr>
                      <tr>
                        <td class="title-table">Warranty</td>
                        <td>No included</td>
                        <td>$250,000</td>
                        <td>$1.000.000</td>
                      </tr>
                      <tr>
                        <td class="title-table">Encryption</td>
                        <td>128/256 bit SHA-2</td>
                        <td>128/256 bit SHA-2</td>
                        <td>128/256 bit SHA-2</td>
                      </tr>
                      <tr>
